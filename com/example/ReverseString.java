...
/**
 * This Program tells the user what a word would be spelt backwards.
...
public final class ReverseString {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            // This tells the user that there was a Error when trying to read the files 
            // It could be the input or output file that could be the problme.    
            reader.close();
            writer.close();
        } catch (IOException e) {
